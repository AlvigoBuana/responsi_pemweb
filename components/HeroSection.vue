      ...
      <div class="card-body">
        <div class="d-flex flex-column align-items-center text-center">
          ...
          <div class="mt-3">
            ...
            <p class="custom-text-secondary mb-1">Full Stack Developer</p>
            <p class="custom-text-muted font-size-sm">Condong Catur, Sleman, Yogyakarta</p>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="col-sm-9 custom-text-secondary">
                      Alvigo Wahyu Buana
                    </div>
                  </div>
                  <hr>
